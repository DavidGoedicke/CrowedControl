...
public struct GateColor
{
    public static readonly Dictionary<GateNums, float4> val =
        new Dictionary<GateNums, float4>
        {
            ...
            { GateNums.NONE, new float4(0, 0, 0.5f, 0) }
        };
}
...
public static class Util
{
    ...
    public static float
        MapRange(this float val, float in_min, float in_max, float out_min,
            float out_max) //https://gist.github.com/nadavmatalon/71ccaf154bc4bd71f811289e78c65918
    {
